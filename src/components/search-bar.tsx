      ...
      {view === 0 ? (
                    ...
                    >
                      <div className="flex items-center gap-2 ">
                        <Image
                          ...
                          alt={poke.name}
                        />
                        <span className="font-semibold font-game text-xl">
        ...
        <>
          ...
          <div
            className={cn(
              pokemons !== null
                ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 w-full gap-4"
                : "flex w-full",
            )}
          >
            {pokemons !== null ? (
              pokemons.map((poke) => (
                ...
                >
                  <CardHeader className="w-full flex flex-col items-center justify-center px-1 gap-3">
                    <CardTitle className="text-center px-0 text-2xl font-game capitalize w-full">
                      {poke?.name}
                    </CardTitle>
              ...
              <span className="font-semibold font-game text-3xl text-center w-full">
                No results found.
              </span>
            ) : (
              isLoading && (
